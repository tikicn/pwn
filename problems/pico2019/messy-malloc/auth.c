...
void print_flag()
{
  ...
  unsigned long ac1 = ((unsigned long *)u->access_code)[0]; //(u->access_code)をunsigned longのポインタへとキャスト。
  unsigned long ac2 = ((unsigned long *)u->access_code)[1]; // unsigned longは8byteであるからちょうど2つ
